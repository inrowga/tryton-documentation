...
existencias. Estas solicitudes las encontraremos en el menu |menu_purchase_request_form|. 
...
* Abriremos el menú |menu_template|.
...
* Marcaremos la opción |supply_on_sale|.
...
* Abriremos el menú |menu_purchase_request_form|.
...
* Nos desplazaremos al menú |menu_purchase_form|.
